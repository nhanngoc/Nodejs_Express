...
(function (h) {
  ...
  n.defaults = {
    ...
    oLanguage: {
      ...
      sInfo: "Hiển thị _START_ đến _END_ trong số _TOTAL_ tất cả",
      sInfoEmpty: "Hiển thị 0 đến 0 trong số 0 tất cả",
      sInfoFiltered: "(filtered from _MAX_ total tất cả)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Show _MENU_ tất cả",
